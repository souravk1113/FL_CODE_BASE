...
Original file is located at
    https://colab.research.google.com/drive/15RiDR6Z8tAzKewjnIxPwWasF6Cwe42FT
"""
...
for i in range(pathFileValid):
  global_pathFileValid.extend(pathFileValid[i])
datasetValid=RaceDataset(global_pathFileValid,labelValid[i],transforms)
